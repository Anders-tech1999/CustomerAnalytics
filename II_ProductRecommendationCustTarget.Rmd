...
-	Approximately half of the transactions involve one, two, or three items, 
 - the largest transaction involves 32 items
-	The most frequently bought item is “whole milk” followed by “other vegetables”

-	The data is provided as a “transactions” class
-	We extract association rules with 
 - support above 0.01 and with a 
 - confidence above 0.3 – this will result in a modest number of rules and involve a suitable number of items
...
Groceries:
 ...
 o Length Distribution of Transactions:
 ...
 o Descriptive Stats of Transaction Lengths:
...
Associatin Rules incl. lift > 3
 - ratio is larger than 1 we have an upward lift – knowing that X happening increases the probability that Y occurs
