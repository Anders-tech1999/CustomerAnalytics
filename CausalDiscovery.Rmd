...
library(dplyr)
library(readr)
retention <- read_csv("C:/Users/Bruger/OneDrive - Aarhus universitet/8. semester - BI/CA - Customer Analytics/Causal Discovery - Production Recommendation og Targeting/retention.csv")
head (retention)
glimpse(retention)

retention_test <- read_csv("C:/Users/Bruger/OneDrive - Aarhus universitet/8. semester - BI/CA - Customer Analytics/Causal Discovery - Production Recommendation og Targeting/retention_test.csv")
```


```{r 2. Test data }
head (retention_test)
glimpse(retention_test)
```
