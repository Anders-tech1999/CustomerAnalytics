...
#### BOOKMARK 11/5-24 Cant load this adequately!!!!

```{r 2. Learning structure and parameters from observational data }
library(dplyr)
retention <- read.csv("C:/Users/Bruger/OneDrive - Aarhus universitet/8. semester - BI/CA - Customer Analytics/Causal Discovery - Production Recommendation og Targeting/retention.csv.zip", header = T, colClasses = "factor" )
retention_test <- read.csv("C:/Users/Bruger/OneDrive - Aarhus universitet/8. semester - BI/CA - Customer Analytics/Causal Discovery - Production Recommendation og Targeting/retention_test.csv.zip", header = T, colClasses = "factor" )
library(readr)
retention_csv <- read_csv("C:/Users/Bruger/OneDrive - Aarhus universitet/8. semester - BI/CA - Customer Analytics/Causal Discovery - Production Recommendation og Targeting/retention.csv.zip")

head (retention_csv)
glimpse(retention_csv)
...
# A Gaussian Bayes net is equivalent to a path analysis model or a sem model with observable variables instead of latent constructs.
```

```{r}
retention_csv <- read_csv("C:/Users/Bruger/OneDrive - Aarhus universitet/8. semester - BI/CA - Customer Analytics/Causal Discovery - Production Recommendation og Targeting/retention.csv.zip", header = T, colClasses = "factor")
