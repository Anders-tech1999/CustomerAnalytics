...
Compares the cluster assignments from two different clustering methods:  
 - k-means and  
 - mixture model
...
o	The “classical” segmentation approach (hierarchical and nonhierarchical) resembles (ligner) in many ways the latent class analysis/finite mixtures of distributions and result often in comparable solutions
